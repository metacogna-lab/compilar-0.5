...
import {
  ...
  assessmentAnalyticsResponseSchema,
 ...
 */
analytics.get('/user/:id', requireAuth, validateQuery(userAnalyticsQuerySchema), async (c) => {
  ...
  return createApiResponse(c, response, userAnalyticsResponseSchema);
});
...
analytics.get('/assessments', requireAuth, requireAdmin, async (c) => {
  ...
  return createApiResponse(c, response, assessmentAnalyticsResponseSchema);
});
...
analytics.get('/teams', requireAuth, requireAdmin, async (c) => {
  ...
  return createApiResponse(c, response, teamAnalyticsResponseSchema);
});
